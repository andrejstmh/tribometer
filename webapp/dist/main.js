...
var routes = [
    ...
    { path: "", component: _components_settings_settings_form_settings_form_component__WEBPACK_IMPORTED_MODULE_4__["SettingsFormComponent"], data: { title: "Settings" } },
...
/* harmony import */ var _components_show_errors_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/show-errors.component */ "./src/app/components/show-errors.component.ts");
/* harmony import */ var _components_settings_settings_form_settings_form_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/settings/settings-form/settings-form.component */ "./src/app/components/settings/settings-form/settings-form.component.ts");
/* harmony import */ var _services_socket_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/socket.service */ "./src/app/services/socket.service.ts");
/* harmony import */ var _services_sygnals_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/sygnals.service */ "./src/app/services/sygnals.service.ts");
/* harmony import */ var _components_controls_tabulator_table_tabulator_table_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/controls/tabulator-table/tabulator-table.component */ "./src/app/components/controls/tabulator-table/tabulator-table.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
            declarations: [
                ...
                _components_show_errors_component__WEBPACK_IMPORTED_MODULE_13__["ShowErrorsComponent"],
                _components_settings_settings_form_settings_form_component__WEBPACK_IMPORTED_MODULE_14__["SettingsFormComponent"],
                _components_controls_tabulator_table_tabulator_table_component__WEBPACK_IMPORTED_MODULE_17__["TabulatorTableComponent"]
            ],
            imports: [
            ...
            providers: [_services_socket_service__WEBPACK_IMPORTED_MODULE_15__["SocketService"], _services_sygnals_service__WEBPACK_IMPORTED_MODULE_16__["SygnalsService"]],
...
var CalibrCurveComponent = /** @class */ (function () {
    ...
    CalibrCurveComponent.prototype.onSave = function () {
        //this.sygnalServ.EditCalibrationCurve(this.selectedCurve.path,)
    };
    CalibrCurveComponent.prototype.onAppendRow = function () {
        //this.sygnalServ.EditCalibrationCurve(this.selectedCurve.path,)
    };
    CalibrCurveComponent.prototype.onDeleteRow = function () {
        //this.sygnalServ.EditCalibrationCurve(this.selectedCurve.path,)
    };
    ...
    CalibrCurveComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_sygnals_service__WEBPACK_IMPORTED_MODULE_2__["SygnalsService"]])
...
var TabulatorTableComponent = /** @class */ (function () {
    function TabulatorTableComponent(compRootEl, renderer) {
        ...
        this.responsiveLayoutCollapseStartOpen = false;
        this.selectable = false; //make rows selectable
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Boolean)
    ], TabulatorTableComponent.prototype, "selectable", void 0);
...
var ExperimentSettings = /** @class */ (function () {
    function ExperimentSettings(user, bearing, outputFileName, workingDirectory, logFileName, totalDuration, program) {
        if (user === void 0) { user = ""; }
        if (bearing === void 0) { bearing = ""; }
        if (outputFileName === void 0) { outputFileName = "results.h5"; }
        if (workingDirectory === void 0) { workingDirectory = "/home/pi/tribometer/"; }
...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(fb) {
        ...
        this.profileForm = this.fb.group({
            ...
            bearing: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            ...
            programme: this.fb.array([
                this.fb.group({
                    ...
                    RPM: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
                    Load: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
                })
            ])
        });
    }
    Object.defineProperty(SettingsComponent.prototype, "programme", {
        get: function () {
            return this.profileForm.get('programme');
        },
        enumerable: true,
        configurable: true
    });
    ...
    SettingsComponent.prototype.addAlias = function () {
...
/*!***********************************************************!*\
  !*** ./src/app/components/workshop/workshop.component.ts ***!
  \***********************************************************/
/*! exports provided: LineChartSettings, WorkshopComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _services_sygnals_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../../services/sygnals.service */ "./src/app/services/sygnals.service.ts");
...
var WorkshopComponent = /** @class */ (function () {
    function WorkshopComponent(socketservice, sygnalsService) {
        this.socketservice = socketservice;
        this.sygnalsService = sygnalsService;
        this.OnMessage$ = null;
        ...
        this.ChartFile = new LineChartSettings();
    }
    ...
    WorkshopComponent.prototype.updateWChartData = function () {
        var _this = this;
        this.sygnalsService.GetDataFromResultFile().subscribe(function (x) {
    ...
    WorkshopComponent.prototype.beginWrite = function () {
        ...
        this.sygnalsService.beginWrite().subscribe(function (x) { return x; });
    ...
    WorkshopComponent.prototype.endWrite = function () {
        ...
        this.sygnalsService.endWrite().subscribe(function (x) { return x; });
    };
    WorkshopComponent.prototype.rotation = function () {
        this.sygnalsService.SetRPM(this.rpmVal).subscribe(function (x) {
            console.log("Rotation " + x);
        });
    };
    WorkshopComponent.prototype.StopRotation = function () {
        this.sygnalsService.SetRPM(0).subscribe(function (x) {
            console.log("StopRotation " + x);
        });
    };
    WorkshopComponent.prototype.loadPlus = function () {
        this.sygnalsService.SetLoad(10).subscribe(function (x) {
            console.log("Load " + x);
        });
    };
    ...
    WorkshopComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_socket_service__WEBPACK_IMPORTED_MODULE_4__["SocketService"], _services_sygnals_service__WEBPACK_IMPORTED_MODULE_5__["SygnalsService"]])
    ], WorkshopComponent);
...
var SocketService = /** @class */ (function () {
    ...
    SocketService.prototype.initSocket = function () {
        ...
        this.subsctiprion = this.socket.subscribe(function (msg) {
...
/***/ "./src/app/services/sygnals.service.ts":
/*!*********************************************!*\
  !*** ./src/app/services/sygnals.service.ts ***!
  \*********************************************/
/*! exports provided: CalibrationCurve, trState, trProgram, trSettings, trResultFileData, trTotalState, SygnalsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SygnalsService", function() { return SygnalsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var SygnalsService = /** @class */ (function () {
    function SygnalsService(http) {
        var _this = this;
        this.http = http;
        this.state = null;
        this.settings = null;
        this.totalstate$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](null);
        this.GetState().subscribe(function (x) { _this.state = x; });
        this.GetSettings().subscribe(function (x) { _this.settings = x; });
    }
    SygnalsService.prototype.getTotalState = function () {
        var _this = this;
    ...
    SygnalsService.prototype.beginWrite = function () {
    ...
    SygnalsService.prototype.endWrite = function () {
    ...
    SygnalsService.prototype.GetCalibrationCurve = function (clbr_curve_name) {
    ...
    SygnalsService.prototype.EditCalibrationCurve = function (clbr_curve_name, curve_data) {
        var url = base_url + ("sett?case=" + clbr_curve_name);
        return this.http.post(url, curve_data, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('EditCalibrationCurve', curve_data)));
    };
    SygnalsService.prototype.GetState = function () {
    ...
    SygnalsService.prototype.GetSettings = function () {
    ...
    SygnalsService.prototype.SetRPM = function (rpm) {
    ...
    SygnalsService.prototype.SetLoad = function (load) {
    ...
    SygnalsService.prototype.GetDataFromResultFile = function () {
     ...
     * @param result - optional value to return as the observable result
     */
    SygnalsService.prototype.handleError = function (operation, result) {
        if (operation === void 0) { operation = 'operation'; }
        return function (error) {
            // TODO: send the error to remote logging infrastructure
            console.error(error); // log to console instead
    ...
    SygnalsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
    ], SygnalsService);
    return SygnalsService;
}());
