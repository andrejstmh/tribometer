...
var ExperimentComponent = /** @class */ (function () {
    ...
    ExperimentComponent.prototype.ngOnInit = function () {
        ...
        this.subsArr.push(this.chartService.onChartDataChanged$.subscribe(function (reOk) {
            _this.currentData = reOk;
        }, function (resErr) { }, function () { }));
        this.subsArr.push(this.chartService.expFileData$.subscribe(function (resOk) { _this.updateChartLines(resOk); }, function (resErr) { }, function () { }));
...
var SettingsComponent = /** @class */ (function () {
    ...
    SettingsComponent.prototype.ngOnInit = function () {
        ...
        this.signalsService.totalstate$.subscribe(function (resOk) {
            if (resOk) {
                //console.log('request');
                //console.log(resOk);
                _this.totState = _models_message_model__WEBPACK_IMPORTED_MODULE_2__["ObjHelper"].DeepCopyOfState(resOk);
    ...
    SettingsComponent.prototype.CreateNewItem = function (Nr) {
        ...
        //    return new CurveRow(0, 0, Nr);
        //}
        return new _models_message_model__WEBPACK_IMPORTED_MODULE_2__["trProgram"](1, this.totState.settings.load, this.totState.settings.rpm, this.totState.settings.temperature_threshold, this.totState.settings.friction_force_threshold, 1);
    };
...
/*!*****************************************!*\
  !*** ./src/app/models/message.model.ts ***!
  \*****************************************/
/*! exports provided: base_url, SERVER_URL, ExperimentStatus, CalibrationCurve, trState, trProgram, trSettings, trTotalState, trResultFileData, SensorsData, SocketMessageData, ObjHelper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ChartService = /** @class */ (function () {
    function ChartService(http, signalsService) {
        ...
        this.expFileData$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](new _models_message_model__WEBPACK_IMPORTED_MODULE_4__["trResultFileData"]([], [], [], [], []));
        var l = [];
        var d1 = [];
        var d2 = [];
        var d3 = [];
        ...
        //}
        this.onChartDataChanged$.next(new _models_message_model__WEBPACK_IMPORTED_MODULE_4__["SensorsData"](-1, -1, -1, -1, -1));
    }
