...
var routes = [
    { path: "settings1", component: _components_settings_settings_form_settings_form_component__WEBPACK_IMPORTED_MODULE_4__["SettingsFormComponent"], data: { title: "Settings" } },
    ...
    { path: "**", component: _components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_6__["NotFoundComponent"], data: { title: "Page not found" } }
];
...
module.exports = "li.selected {\r\n\t/*background-color: #CFD8DC !important;*/\r\n\tcolor: black;\r\n\tfont-weight: bold;\r\n\tfont-size: large;\r\n}\r\n\r\n.ccurves li:hover {\r\n\tcolor: #607D8B;\r\n\tcursor: pointer;\r\n\t/*background-color: #DDD;*/\r\n\tleft: .1em;\r\n}\r\n\r\n/*.card-header {\r\n\tbackground-color: transparent;\r\n}*/\r\n\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/components/calibr-curve/calibr-curve.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/components/calibr-curve/calibr-curve.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
var CalibrCurveComponent = /** @class */ (function () {
    ...
    CalibrCurveComponent.prototype.onSelect = function (curve) {
        var _this = this;
        if (curve) {
    ...
    CalibrCurveComponent.prototype.SaveData = function () {
        ...
        this.sygnalServ.EditCalibrationCurve(this.selectedCurve.path, cd).subscribe(function (resOk) { }, function (resErr) { }, function () { });
    };
...
/***/ "./src/app/components/controls/tabulator-table/tabulator-table.component.html":
/*!************************************************************************************!*\
  !*** ./src/app/components/controls/tabulator-table/tabulator-table.component.html ***!
  \************************************************************************************/
/*! no static exports found */
...
var TabulatorTableComponent = /** @class */ (function () {
    ...
    TabulatorTableComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./tabulator-table.component.html */ "./src/app/components/controls/tabulator-table/tabulator-table.component.html"),
...
var ExperimentComponent = /** @class */ (function () {
    ...
    ExperimentComponent.prototype.updateWChartData = function () {
        ...
        this.signalsService.GetDataFromResultFile().subscribe(function (x) {
            if (x) {
                ...
                _this.ChartFile.lineChartData[0].data = _this.removeNaN(x.temperature);
                _this.ChartFile.lineChartData[1].data = _this.removeNaN(x.RPM);
                _this.ChartFile.lineChartData[2].data = _this.removeNaN(x.load);
                _this.ChartFile.lineChartData[3].data = _this.removeNaN(x.friction);
    ...
    ExperimentComponent.prototype.beginWrite = function () {
        ...
        this.signalsService.beginWrite().subscribe(function (resOk) {
            ...
            _this.status = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["ExperimentStatus"].started;
    ...
    ExperimentComponent.prototype.endWrite = function () {
        ...
        this.signalsService.endWrite().subscribe(function (resOk) {
            _this.status = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["ExperimentStatus"].completed;
    ...
    ExperimentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_socket_service__WEBPACK_IMPORTED_MODULE_4__["SocketService"], _services_signals_service__WEBPACK_IMPORTED_MODULE_6__["SignalsService"]])
    ], ExperimentComponent);
...
/***/ "./src/app/components/settings/settings-form/settings-form.component.css":
/*!*******************************************************************************!*\
  !*** ./src/app/components/settings/settings-form/settings-form.component.css ***!
  \*******************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvc2V0dGluZ3Mvc2V0dGluZ3MtZm9ybS9zZXR0aW5ncy1mb3JtLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/components/settings/settings-form/settings-form.component.html":
/*!********************************************************************************!*\
  !*** ./src/app/components/settings/settings-form/settings-form.component.html ***!
  \********************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container\">\r\n\r\n\r\n  <div [hidden]=\"submitted\">\r\n    <h1>Settings</h1>\r\n\r\n    <!--public user: string=\"\",\r\n    public bearing: string=\"\",\r\n    public outputFileName: string=\"results.h5\",\r\n    public workingDirectory: string=\"\",\r\n    public logFileName: string=\"log.txt\",\r\n    public totalDuration: number = 72,\r\n    public program: ProgramPoint[]=[]-->\r\n\r\n    <form (ngSubmit)=\"onSubmit()\" #settingsForm=\"ngForm\">\r\n      <div class=\"form-group\">\r\n        <label for=\"name\">*Name</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"user\" placeholder=\"Example: John Anyone\"\r\n               required\r\n               [(ngModel)]=\"model.user\" name=\"user\" #user=\"ngModel\" />\r\n        <div [hidden]=\"user.valid || user.pristine\"\r\n             class=\"alert alert-danger\">\r\n          Name is required\r\n        </div>\r\n      </div>\r\n\r\n      <div class=\"form-group\">\r\n        <label for=\"name\">*Bearing description</label>\r\n        <textarea type=\"text\" class=\"form-control\" id=\"bearing\" placeholder=\"Example: Thrust ball bearing 65 (2011) 245-248\"\r\n                  required\r\n                  [(ngModel)]=\"model.bearing\" name=\"bearing\" #bearing=\"ngModel\"></textarea>\r\n        <div [hidden]=\"bearing.valid || bearing.pristine\"\r\n             class=\"alert alert-danger\">\r\n          Bering description is required\r\n        </div>\r\n      </div>\r\n\r\n      <div class=\"form-group\">\r\n        <label for=\"name\">*Output file name</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"bearing\" placeholder=\"Example: result.h5\"\r\n                  required\r\n                  [(ngModel)]=\"model.outputFileName\" name=\"outputFileName\" #outputFileName=\"ngModel\"/>\r\n        <div [hidden]=\"outputFileName.valid || outputFileName.pristine\"\r\n             class=\"alert alert-danger\">\r\n          Output file name is required\r\n        </div>\r\n      </div>\r\n\r\n      <!--<div class=\"form-group\">\r\n        <label for=\"name\">*Log file name</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"logFileName\" placeholder=\"Example: log.txt\"\r\n                  required\r\n                  [(ngModel)]=\"model.logFileName\" name=\"logFileName\" #logFileName=\"ngModel\"/>\r\n        <div [hidden]=\"logFileName.valid || logFileName.pristine\"\r\n             class=\"alert alert-danger\">\r\n          Log file name is required\r\n        </div>\r\n      </div>-->\r\n\r\n      <!--<div class=\"form-group\">\r\n        <label for=\"name\">Working directory</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"workingDirectory\" value=\"home\" placeholder=\"Example: /home/pi/tribometer/\"\r\n                  [(ngModel)]=\"model.workingDirectory\" name=\"workingDirectory\" #workingDirectory=\"ngModel\"/>\r\n      </div>-->\r\n\r\n      <!--<div class=\"form-group\">\r\n    <label for=\"alterEgo\">Alter Ego</label>\r\n    <input type=\"text\" class=\"form-control\" id=\"alterEgo\"\r\n           [(ngModel)]=\"model.alterEgo\" name=\"alterEgo\">\r\n  </div>\r\n\r\n  <div class=\"form-group\">\r\n    <label for=\"power\">Hero Power</label>\r\n    <select class=\"form-control\" id=\"power\"\r\n            required\r\n            [(ngModel)]=\"model.power\" name=\"power\"\r\n            #power=\"ngModel\">\r\n      <option *ngFor=\"let pow of powers\" [value]=\"pow\">{{pow}}</option>\r\n    </select>\r\n    <div [hidden]=\"power.valid || power.pristine\" class=\"alert alert-danger\">\r\n      Power is required\r\n    </div>\r\n  </div>-->\r\n\r\n      <button type=\"submit\" class=\"btn btn-success\" [disabled]=\"!settingsForm.form.valid\">Start</button>\r\n      <!--<button type=\"button\" class=\"btn btn-default\" (click)=\"newHero(); settingsForm.reset()\">New Hero</button>-->\r\n    </form>\r\n  </div>\r\n\r\n  <div [hidden]=\"!submitted\">\r\n    <h2>You submitted the following:</h2>\r\n    <div class=\"row\">\r\n      <div class=\"col-xs-3\">Name</div>\r\n      <div class=\"col-xs-9\">{{ model.user }}</div>\r\n    </div>\r\n    <div class=\"row\">\r\n      <div class=\"col-xs-3\">Alter Ego</div>\r\n      <div class=\"col-xs-9\">{{ model.bearing }}</div>\r\n    </div>\r\n    <div class=\"row\">\r\n      <div class=\"col-xs-3\">Power</div>\r\n      <div class=\"col-xs-9\">{{ model.outputFileName }}</div>\r\n    </div>-->\r\n    <br>\r\n    <button class=\"btn btn-primary\" (click)=\"submitted=false\">Edit</button>\r\n  </div>\r\n</div>\n"

/***/ }),

/***/ "./src/app/components/settings/settings-form/settings-form.component.ts":
/*!******************************************************************************!*\
  !*** ./src/app/components/settings/settings-form/settings-form.component.ts ***!
  \******************************************************************************/
/*! exports provided: ProgramPoint, ExperimentSettings, SettingsFormComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProgramPoint", function() { return ProgramPoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExperimentSettings", function() { return ExperimentSettings; });
...
var ProgramPoint = /** @class */ (function () {
    function ProgramPoint(duration, load, RPM) {
...
var ExperimentSettings = /** @class */ (function () {
    function ExperimentSettings(user, bearing, outputFileName, 
    //public workingDirectory: string ="/home/pi/tribometer/",
    //public logFileName: string="log.txt",
    totalDuration, program) {
        if (user === void 0) { user = ""; }
        if (bearing === void 0) { bearing = ""; }
        if (outputFileName === void 0) { outputFileName = "results.h5"; }
        if (totalDuration === void 0) { totalDuration = 72; }
...
var SettingsFormComponent = /** @class */ (function () {
    ...
    SettingsFormComponent.prototype.onSubmit = function () { this.submitted = true; };
    SettingsFormComponent.prototype.newHero = function () {
        this.model = new ExperimentSettings();
    };
    SettingsFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-settings-form',
            template: __webpack_require__(/*! ./settings-form.component.html */ "./src/app/components/settings/settings-form/settings-form.component.html"),
            styles: [__webpack_require__(/*! ./settings-form.component.css */ "./src/app/components/settings/settings-form/settings-form.component.css")]
        }),
...
module.exports = "<div class=\"container\">\r\n    <div *ngIf=\"totState\" [hidden]=\"submitted\">\r\n        <h1>Settings</h1>\r\n\r\n        <!\r\n        public working_directory: string,\r\n        public user: string,\r\n        public bearing: string,\r\n        public output_file: string,\r\n        public log_file: string,\r\n        public friction_force_calibration_curve_file: string,\r\n        public load_calibration_curve_file: string,\r\n        public rpm_calibration_curve_file: string,\r\n        // miliseconds\r\n        public listening_interval: number,\r\n        // listening intervals count\r\n        public recording_cycle: 2,\r\n        // listening intervals count\r\n        public visualisation_cycle: number,\r\n        // hours (manual mode)\r\n        public total_duration: number,\r\n        public manual_mode: boolea\r\n        public friction_force_treshold: number,\r\n        // C\r\n        public temperature_treshold: number,\r\n        -->\r\n\r\n        <form (ngSubmit)=\"onSubmit()\" #settingsForm=\"ngForm\">\r\n            <div class=\"form-group\">\r\n                <label for=\"name\">*Name</label>\r\n                <input type=\"text\" class=\"form-control\" id=\"user\" placeholder=\"Example: John Anyone\"\r\n                       required\r\n                       [(ngModel)]=\"totState.settings.user\" name=\"user\" #user=\"ngModel\" />\r\n                <div [hidden]=\"user.valid || user.pristine\"\r\n                     class=\"alert alert-danger\">\r\n                    Name is required\r\n                </div>\r\n            </div>\r\n\r\n            <div class=\"form-group\">\r\n                <label for=\"name\">*Bearing description</label>\r\n                <textarea type=\"text\" class=\"form-control\" id=\"bearing\" placeholder=\"Example: Thrust ball bearing 65 (2011) 245-248\"\r\n                          required\r\n                          [(ngModel)]=\"totState.settings.bearing\" name=\"bearing\" #bearing=\"ngModel\"></textarea>\r\n                <div [hidden]=\"bearing.valid || bearing.pristine\"\r\n                     class=\"alert alert-danger\">\r\n                    Bering description is required\r\n                </div>\r\n            </div>\r\n\r\n            <div class=\"form-group\">\r\n                <label for=\"name\">*Output file name</label>\r\n                <input type=\"text\" class=\"form-control\" id=\"output_file\" placeholder=\"Example: result.h5\"\r\n                       required\r\n                       [(ngModel)]=\"totState.settings.output_file\" name=\"output_file\" #output_file=\"ngModel\" />\r\n                <div [hidden]=\"output_file.valid || output_file.pristine\"\r\n                     class=\"alert alert-danger\">\r\n                    Output file name is required\r\n                </div>\r\n            </div>\r\n\r\n            <div class=\"form-group\">\r\n                <label for=\"name\">*Recording period</label>\r\n                <input type=\"text\" class=\"form-control\" id=\"recording_cycle\" placeholder=\"Example: 1\"\r\n                       required\r\n                       [(ngModel)]=\"totState.settings.recording_cycle\" name=\"recording_cycle\" #recording_cycle=\"ngModel\" />\r\n                <div [hidden]=\"recording_cycle.valid || recording_cycle.pristine\"\r\n                     class=\"alert alert-danger\">\r\n                    recording_cycle is required\r\n                </div>\r\n            </div>\r\n\r\n            <div class=\"form-group\">\r\n                <label for=\"name\">*Experiment total duration, hours</label>\r\n                <input type=\"text\" class=\"form-control\" id=\"total_duration\" placeholder=\"Example: 24\"\r\n                       required\r\n                       [(ngModel)]=\"totState.settings.total_duration\" name=\"total_duration\" #total_duration=\"ngModel\" />\r\n                <div [hidden]=\"total_duration.valid || total_duration.pristine\"\r\n                     class=\"alert alert-danger\">\r\n                    total_duration is required\r\n                </div>\r\n            </div>\r\n\r\n            <div class=\"form-group\">\r\n                <label for=\"name\">*Friction force threshold, N</label>\r\n                <input type=\"text\" class=\"form-control\" id=\"friction_force_treshold\" placeholder=\"Example: 2\"\r\n                       required\r\n                       [(ngModel)]=\"totState.settings.friction_force_treshold\" name=\"friction_force_treshold\" #friction_force_treshold=\"ngModel\" />\r\n                <div [hidden]=\"friction_force_treshold.valid || friction_force_treshold.pristine\"\r\n                     class=\"alert alert-danger\">\r\n                    Friction force threshold is required\r\n                </div>\r\n            </div>\r\n\r\n            <div class=\"form-group\">\r\n                <label for=\"name\">*Temperature threshold, °C</label>\r\n                <input type=\"text\" class=\"form-control\" id=\"temperature_treshold\" placeholder=\"Example: 2\"\r\n                       required\r\n                       [(ngModel)]=\"totState.settings.temperature_treshold\" name=\"temperature_treshold\" #temperature_treshold=\"ngModel\" />\r\n                <div [hidden]=\"temperature_treshold.valid || temperature_treshold.pristine\"\r\n                     class=\"alert alert-danger\">\r\n                    Temperature threshold is required\r\n                </div>\r\n            </div>\r\n            <button type=\"submit\" class=\"btn btn-success\" [disabled]=\"!settingsForm.form.valid\">Applay</button>\r\n        </form>\r\n    </div>\r\n</div>\r\n"
...
/* harmony import */ var _services_signals_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../services/signals.service */ "./src/app/services/signals.service.ts");




var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(signalsService) {
        this.signalsService = signalsService;
        this.totState = null;
        this.submitted = false;
    }
    SettingsComponent.prototype.ngOnInit = function () {
        ...
        this.signalsService.totalstate$.subscribe(function (resOk) {
            if (resOk) {
                console.log('request');
                console.log(resOk);
                _this.totState = Object(_models_message_model__WEBPACK_IMPORTED_MODULE_2__["DeepCopyOfState"])(resOk);
                console.log('form data');
                console.log(_this.totState);
            }
            else {
                _this.totState = null;
            }
    ...
    SettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_signals_service__WEBPACK_IMPORTED_MODULE_3__["SignalsService"]])
    ], SettingsComponent);
...
/***/ "./src/app/components/trib-controls/trib-controls.component.html":
/*!***********************************************************************!*\
  !*** ./src/app/components/trib-controls/trib-controls.component.html ***!
  \***********************************************************************/
/*! no static exports found */
...
var TribControlsComponent = /** @class */ (function () {
    ...
    TribControlsComponent.prototype.secondsToSting = function (s) {
        var t = Math.floor(s / 86400);
        var ds = t > 0 ? (t < 10 ? " " + String(t) : String(t)) : "  ";
        var tt = s % 86400;
        t = Math.floor(tt / 3600);
...
/*!*****************************************!*\
  !*** ./src/app/models/message.model.ts ***!
  \*****************************************/
/*! exports provided: base_url, SERVER_URL, ExperimentStatus, CalibrationCurve, trState, trProgram, trSettings, trTotalState, trResultFileData, SensorsData, SocketMessageData, DeepCopyOfState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeepCopyOfState", function() { return DeepCopyOfState; });
var base_url = "http://localhost:8787/";
var SERVER_URL = 'ws://localhost:8787/ss';
...
var trSettings = /** @class */ (function () {
    ...
    visualisation_cycle, 
    // hours (manual mode)
    total_duration, rpm, manual_mode, program, 
    //=================================================================
    //control parameters
    // [N]
    ...
    trSettings.prototype.copy = function () {
        ...
        // hours (manual mode)
        this.total_duration, this.rpm, this.manual_mode, pr, this.friction_force_threshold, this.temperature_threshold, this.vibration_threshold, this.loadRegualtionAccuracy, this.RPMRegualtionAccuracy, this.readme);
    };
    return trSettings;
}());
...
var trResultFileData = /** @class */ (function () {
    function trResultFileData(time, load, RPM, temperature, friction) {
        this.time = time;
        this.load = load;
        this.RPM = RPM;
...
var SensorsData = /** @class */ (function () {
    function SensorsData(time, temperature, rotationrate, load, frictionforce) {
        this.time = time;
        this.temperature = temperature;
...
var SocketMessageData = /** @class */ (function () {
    function SocketMessageData(sensorData, state) {
...
function DeepCopyOfState(stateObj) {
    if (!stateObj) {
        return null;
    }
        ...
        var pr_1 = [];
        this.program.forEach(function (it) { pr_1.push(DeepCopyOfState(it)); });
        ...
        // hours (manual mode)
        stateObj.total_duration, stateObj.rpm, stateObj.manual_mode, pr_1, stateObj.friction_force_threshold, stateObj.temperature_threshold, stateObj.vibration_threshold, stateObj.loadRegualtionAccuracy, stateObj.RPMRegualtionAccuracy, stateObj.readme);
    }
...
var ChartService = /** @class */ (function () {
    function ChartService(http) {
        this.http = http;
        this.onChartDataChanged = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](new _models_message_model__WEBPACK_IMPORTED_MODULE_4__["SensorsData"](NaN, NaN, NaN, NaN, NaN));
        ...
        //}
        this.onChartDataChanged.next(new _models_message_model__WEBPACK_IMPORTED_MODULE_4__["SensorsData"](NaN, NaN, NaN, NaN, NaN));
    }
...
var SignalsService = /** @class */ (function () {
    ...
    SignalsService.prototype.beginWrite = function () {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["base_url"] + "beginw";
    ...
    SignalsService.prototype.endWrite = function () {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["base_url"] + "endw";
    ...
    SignalsService.prototype.GetCalibrationCurve = function (clbr_curve_name) {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["base_url"] + ("sett?case=" + clbr_curve_name);
    ...
    SignalsService.prototype.GetState = function () {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["base_url"] + "sett?case=st";
    ...
    SignalsService.prototype.GetSettings = function () {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["base_url"] + "sett?case=base";
    ...
    SignalsService.prototype.SetRPM = function (rpm) {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["base_url"] + ("sett?case=rpm&val=" + rpm);
    ...
    SignalsService.prototype.SetLoad = function (load) {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["base_url"] + ("sett?case=load&val=" + load);
    ...
    SignalsService.prototype.GetDataFromResultFile = function () {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_5__["base_url"] + "sett?case=resultfile";
...
var SocketService = /** @class */ (function () {
    function SocketService(http) {
        ...
        this.socket = Object(rxjs_webSocket__WEBPACK_IMPORTED_MODULE_5__["webSocket"])(_models_message_model__WEBPACK_IMPORTED_MODULE_6__["SERVER_URL"]);
    ...
    SocketService.prototype.startListen = function () {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_6__["base_url"] + "beginr";
    ...
    SocketService.prototype.stopListen = function () {
        var url = _models_message_model__WEBPACK_IMPORTED_MODULE_6__["base_url"] + "endr";
