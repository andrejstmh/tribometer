...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["forkJoin"])(this.signalsService.GetState(), this.signalsService.GetSettings()).subscribe(function (_a) {
            ...
            _this.signalsService.totalstate$.next(new _services_signals_service__WEBPACK_IMPORTED_MODULE_4__["trTotalState"](stt, st));
    ...
    AppComponent.prototype.SocketServiceStart = function () {
        ...
        this.socketService.startListen().subscribe(function (x) {
            ...
            _this.socketService.socket.subscribe(function (x) {
                //console.log("updateChartData");
                _this.chartService.updateChartData(x);
            });
...
var CalibrCurveComponent = /** @class */ (function () {
    ...
    CalibrCurveComponent.prototype.SaveData = function () {
        var res = this.data$.value;
        var cd = new _services_signals_service__WEBPACK_IMPORTED_MODULE_2__["CalibrationCurve"]();
...
/*!***********************************************************!*\
  !*** ./src/app/components/settings/settings.component.ts ***!
  \***********************************************************/
/*! exports provided: ProgramPoint, ExperimentSettings, SettingsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SettingsComponent = /** @class */ (function () {
    ...
    SettingsComponent.prototype.ngOnInit = function () {
        ...
        this.signalsService.totalstate$.subscribe(function (resOk) {
            if (resOk) {
                console.log(resOk);
                _this.totState = Object(_services_signals_service__WEBPACK_IMPORTED_MODULE_2__["DeepCopyOfState"])(resOk);
            }
            else {
                _this.totState = null;
            }
...
var ChartService = /** @class */ (function () {
    function ChartService(http) {
        this.http = http;
        this.onChartDataChanged = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](new _socket_service__WEBPACK_IMPORTED_MODULE_4__["SensorsData"](NaN, NaN, NaN, NaN, NaN));
        ...
        //}
        this.onChartDataChanged.next(new _socket_service__WEBPACK_IMPORTED_MODULE_4__["SensorsData"](NaN, NaN, NaN, NaN, NaN));
    }
...
/*!*********************************************!*\
  !*** ./src/app/services/signals.service.ts ***!
  \*********************************************/
/*! exports provided: CalibrationCurve, trState, trProgram, trSettings, trResultFileData, trTotalState, DeepCopyOfState, SignalsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var trState = /** @class */ (function () {
    function trState(description, VFD_on, load_on, stopTime, stopTlim, stopFlim, listening, writing, autoMode, manualMode, manualFictionForceTreshold) {
        ...
        this.manualFictionForceTreshold = manualFictionForceTreshold;
    }
    trState.prototype.copy = function () {
        return new trState(this.description, this.VFD_on, this.load_on, this.stopTime, this.stopTlim, this.stopFlim, this.listening, this.writing, this.autoMode, this.manualMode, this.manualFictionForceTreshold);
    };
    return trState;
}());
...
var trSettings = /** @class */ (function () {
    ...
    visualisation_cycle, 
    // hours (manual mode)
    total_duration, manual_mode, program, 
    //=================================================================
    //control parameters
    // [N]
    friction_force_treshold, 
    // C
    ...
    readme) {
        ...
        this.program = program;
        this.friction_force_treshold = friction_force_treshold;
        this.temperature_treshold = temperature_treshold;
        this.vibration_treshold = vibration_treshold;
    ...
    trSettings.prototype.copy = function () {
        ...
        // hours (manual mode)
        this.total_duration, this.manual_mode, pr, this.friction_force_treshold, this.temperature_treshold, this.vibration_treshold, this.loadRegualtionAccuracy, this.RPMRegualtionAccuracy, this.readme);
    };
    return trSettings;
}());
...
function DeepCopyOfState(stateObj) {
    if (!stateObj) {
        ...
        // hours (manual mode)
        stateObj.total_duration, stateObj.manual_mode, pr_1, stateObj.friction_force_treshold, stateObj.temperature_treshold, stateObj.vibration_treshold, stateObj.loadRegualtionAccuracy, stateObj.RPMRegualtionAccuracy, stateObj.readme);
    }
    else if (stateObj instanceof trState) {
        return new trState(stateObj.description, stateObj.VFD_on, stateObj.load_on, stateObj.stopTime, stateObj.stopTlim, stateObj.stopFlim, stateObj.listening, stateObj.writing, stateObj.autoMode, stateObj.manualMode, stateObj.manualFictionForceTreshold);
    }
...
var SignalsService = /** @class */ (function () {
    ...
    SignalsService.prototype.getTotalState = function () {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])(this.GetState(), this.GetSettings()).subscribe(function (_a) {
            var st = _a[0], stt = _a[1];
            _this.totalstate$.next(new trTotalState(stt, st));
        });
    };
    SignalsService.prototype.beginWrite = function () {
        var url = base_url + "beginw";
    ...
    SignalsService.prototype.GetCalibrationCurve = function (clbr_curve_name) {
        var url = base_url + ("sett?case=" + clbr_curve_name);
    ...
    SignalsService.prototype.GetSettings = function () {
        var url = base_url + "sett?case=base";
    ...
    SignalsService.prototype.SetRPM = function (rpm) {
        var url = base_url + ("sett?case=rpm&val=" + rpm);
    ...
    SignalsService.prototype.SetLoad = function (load) {
        var url = base_url + ("sett?case=load&val=" + load);
    ...
    SignalsService.prototype.GetDataFromResultFile = function () {
        var url = base_url + "sett?case=resultfile";
...
/*!********************************************!*\
  !*** ./src/app/services/socket.service.ts ***!
  \********************************************/
/*! exports provided: SensorsData, SocketService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SocketService = /** @class */ (function () {
    function SocketService(http) {
        ...
        this.socket = Object(rxjs_webSocket__WEBPACK_IMPORTED_MODULE_5__["webSocket"])(SERVER_URL);
    ...
    SocketService.prototype.initSocket = function () {
        ...
        this.subsctiprion.push(this.socket.subscribe(function (msg) {
            ...
            //console.log('msg');
            _this.lastData$.next(msg);
            //this.buffer.push(msg);
            //if(this.buffer.length>100){
            //  this.buffer.shift();
            //}
        }, function (err) { return console.log(err); }, // Called if at any point WebSocket API signals some kind of error.
        function () { return console.log('complete'); } // Called when connection is closed (for whatever reason).
        ));
    };
    ...
    SocketService.prototype.startListen = function () {
        var url = "http://localhost:8787/beginr";
    ...
    SocketService.prototype.stopListen = function () {
        var url = "http://localhost:8787/endr";
