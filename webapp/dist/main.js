...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(signalsService) {
        this.signalsService = signalsService;
        this.outputFileName$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    ...
    SettingsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.fileExists$ = this.outputFileName$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (fileName) {
        ...
        this.signalsService.totalstate$.subscribe(function (resOk) {
            if (resOk) {
                ...
                //console.log('request');
                //console.log(resOk);
                _this.totState = _models_message_model__WEBPACK_IMPORTED_MODULE_4__["ObjHelper"].DeepCopyOfState(resOk);
    ...
    SettingsComponent.prototype.CreateNewItem = function (Nr) {
        ...
        //    return new CurveRow(0, 0, Nr);
        //}
        return new _models_message_model__WEBPACK_IMPORTED_MODULE_4__["trProgram"](1, this.totState.settings.load, this.totState.settings.rpm, this.totState.settings.temperature_threshold, this.totState.settings.friction_force_threshold, 1);
    };
